...
from .model import querysuggestion_model
...
class querysuggestion:
    ...
    def __init__(self, weights_path=None,
        ...
        if weights_path is None:
            weights_path = resource_filename(__name__,
                                             'querysuggestion_weights.hdf5')

        if vocab_path is None:
            vocab_path = resource_filename(__name__,
                                           'querysuggestion_vocab.json')
        ...
        self.model = querysuggestion_model(self.num_classes,
                                      cfg=self.config,
    ...
    def generate(self, n=1, return_as_list=False, prefix=None,
        ...
        for _ in iterable:
            gen_text, _ = querysuggestion_generate(self.model,
                                           self.vocab,
                                           self.indices_char,
                                           temperature,
    ...
    def save(self, weights_path="QuerySuggestion_weights.hdf5"):
    ...
    def train_from_file(self, file_path, header=True, delim="\n",
        ...
        context_labels = None
        if context:
            texts, context_labels = querysuggestion_texts_from_file_context(
                file_path)
        else:
            texts = querysuggestion_texts_from_file(file_path, header,
                                               delim, is_csv)
    ...
    def encode_text_vectors(self, texts, pca_dims=50, tsne_dims=None,
        ...
        for text in texts:
            ...
            encoded_text = querysuggestion_encode_sequence(text_aug, self.vocab,
                                                      maxlen)
